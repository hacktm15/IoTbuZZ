...
class SlidingTabStrip extends LinearLayout {
    ...
    SlidingTabStrip(Context context, AttributeSet attrs) {
        ...
        mDefaultBottomBorderColor = setColorAlpha(Color.WHITE, DEFAULT_BOTTOM_BORDER_COLOR_ALPHA);

        mDefaultTabColorizer = new SimpleTabColorizer();
        mDefaultTabColorizer.setIndicatorColors(getResources().getColor(android.R.color.holo_blue_dark));
