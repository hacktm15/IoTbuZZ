...
package ro.hacktm.smarthome.common;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    /**
     * Set the custom {@link ro.hacktm.smarthome.common.SlidingTabLayout.TabColorizer} to be used.
     * <p/>
    ...
    /**
     * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link ro.hacktm.smarthome.common.SlidingTabLayout} you are
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tabView.setLayoutParams(new LinearLayout.LayoutParams(0, LayoutParams.WRAP_CONTENT, 1f));
     ...
     * {@link #setCustomTabColorizer(ro.hacktm.smarthome.common.SlidingTabLayout.TabColorizer)}.
     */
